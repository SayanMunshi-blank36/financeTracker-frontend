  ...
  return (
    <>
      <section className="h-full md:mx-28">
        <h1 className="mt-8 md:mt-2 w-full flex items-center justify-center text-center md:mb-16 mb-2 text-3xl font-bold mx-auto">
          <FaSignInAlt className="mr-3 text-3xl" />
          LOG IN
        </h1>
